...
extraction operators also can be overloaded to perform input and output for 
user-defined types like an object.
...
int main() {
   ...
   cout << "Enter the value of object : feet and inches" << endl;
   cin >> D3;// invoke overloaded function
